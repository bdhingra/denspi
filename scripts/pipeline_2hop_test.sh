...
BASE_DIR="downloads/2hop_test"
IN_QRY="dev_qrys.json"
IN_DOC="twohop-paragraphs-00001-of-00010_120K.json"
...
NUM_TMPL="5"
NUM_INTERMEDIATE="10"
OUT_DIR="output/dump_1hop_test_template_minlen${MINPARALEN}_filt${FILT}_numint${NUM_INTERMEDIATE}"
...
python scripts/create_templates_2hop.py $BASE_DIR/$IN_QRY $BASE_DIR/$QRY_FILE 1 --template_file $TEMPLATES --answer_file $PREDFILE --top_k ${NUM_INTERMEDIATE} --num_templates $NUM_TMPL
