...
#python scripts/create_templates_2hop.py $BASE_DIR/$IN_QRY $BASE_DIR/$QRY_FILE 1 --template_file $TEMPLATES --answer_file $PREDFILE.top${NUM_INTERMEDIATE} --top_k ${NUM_INTERMEDIATE} --num_templates $NUM_TMPL
...
#python scripts/create_templates_2hop.py $BASE_DIR/$IN_QRY $BASE_DIR/$QRY_FILE 2 --template_file $TEMPLATES --answer_file $PREDFILE.top${NUM_INTERMEDIATE} --top_k ${NUM_INTERMEDIATE} --num_templates $NUM_TMPL
